...
class BLEHandler : NSObject, ObservableObject, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    func manuallyConnect() {
        ...
        guard central.state == .poweredOn, bleState == .disconnected else { return }
        ...
        for characteristic in characteristics {
            ...
            if characteristic.uuid == keepAliveUUID {
                ...
                if characteristic.properties.contains(.notify) {
                    Logger.logger?.log("Characteristic supports notify, subscribing")
